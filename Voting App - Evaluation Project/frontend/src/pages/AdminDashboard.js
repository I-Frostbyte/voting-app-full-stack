      ...
      <div id="second-section" className="w-full">
        ...
        <div className="justify-left text-left ml-8 pt-3">
          ...
          <p className="text-slate-500 font-semibold pb-3">
            Welcome to the Voteroo Admin Control
          </p>
          <p className="text-slate-500 font-medium pb-3 py-2">
            Here you can create and monitor elections and the electoral process
          </p>
        </div>
        ...
        <div className="flex items-center mt-10">
          ...
          />
          <div className="pl-5">
            <p className="text-slate-500 font-semibold">Create a new poll</p>
          </div>
        </div>
        ...
        <div className="md:grid md:grid-cols-2 grid grid-cols-1 gap-4 md:px-0 ml-8 pb-20 md:pt-40 pt-10">
          <div className="w-full shadow-2xl p-5 mr-5" id="ongoing-election">
            ...
            <div className="py-2">
              <div className="flex items-center justify-between">
                <p className="text-slate-500 font-bold pb-3 w-1/2 mr-2">
              ...
              <div className="flex items-center justify-between">
                <p className="text-slate-500 font-bold pb-3 w-1/2 mr-2">
                  Director of Sports Student Council
                </p>
                <div className="bg-green-400 rounded-3xl p-2"></div>
          ...
          <div
            className="md:w-3/4 md:ml-5 shadow-2xl p-3 md:pb-0 pb-64"
            id="ongoing-election"
          >
