  ...
  return (
    <div className='container object-left w-2/12 border-r border-b border-gray-400 h-1/2'>
        ...
        <div className="py-10 mb-32 text-black text-center">
            <Link to="/admin-dashboard" className='py-3 my-3 hover:bg-gray-300 items-center flex'><AiFillHome size={20} className='ml-6 mr-6' />Dashboard</Link>
            <Link to="/polling-page" className='py-3 my-3 hover:bg-gray-300 items-center flex'><MdHowToVote size={20} className='ml-6 mr-6' />Create a Poll</Link>
